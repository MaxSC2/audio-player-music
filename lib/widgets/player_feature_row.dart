    ...
    return SingleChildScrollView(
      ...
      child: Row(
        children: [
          ...
          // Music Bookmarks — tap открывает список, long-press ставит/убирает
          // закладку в текущей позиции воспроизведения.
          GestureDetector(
            onLongPress: () {
            ...
            onTap: () => showTrackBookmarks(context, track),
            ),
          ),
          const SizedBox(width: 14),
          ...
          // Volume (E3-часть 1): компактный слайдер громкости.
          const VolumeControl(),
          const SizedBox(width: 14),
...
// конец файла: _showTrackBookmarks перенесён в track_bookmarks_sheet.dart
